    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_index', models.ForeignKey(db_column='request_index', on_delete=django.db.models.deletion.CASCADE, related_name='ex2_request_info', to='ex2.requestinfo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detected_index', models.ForeignKey(db_column='detected_index', on_delete=django.db.models.deletion.CASCADE, related_name='ex2_detectednumbers', to='ex2.detectednumbers')),
            ],
            options={
