...
class DetectedNumbers(models.Model):
    ...
    request_index = models.ForeignKey("RequestInfo", related_name="googlestar_request_info", on_delete=models.CASCADE, db_column="request_index")
...
class Candidates(models.Model):
    detected_index = models.ForeignKey("DetectedNumbers", related_name="googlestar_detectednumbers", on_delete=models.CASCADE, db_column="detected_index")
