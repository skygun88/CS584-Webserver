# Generated by Django 3.2.8 on 2021-11-04 06:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_index', models.ForeignKey(db_column='request_index', on_delete=django.db.models.deletion.CASCADE, related_name='request_info', to='kakao.requestinfo')),
            ],
            options={
