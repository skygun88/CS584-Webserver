...
class DetectedNumbers(models.Model):
    ...
    request_index = models.ForeignKey("RequestInfo", related_name="ex1_request_info", on_delete=models.CASCADE, db_column="request_index")
...
class Candidates(models.Model):
    detected_index = models.ForeignKey("DetectedNumbers", related_name="ex1_detectednumbers", on_delete=models.CASCADE, db_column="detected_index")
